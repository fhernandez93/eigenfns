...
\caption{Left: the original cluster montage \protect\path{band_montage_398_607_15_non_ideal.png}; right: our regeneration (same layout). The grey/bright row pattern (localized band-edge rows, extended deep-window rows) is reproduced tile for tile in character; the $\pm2$ labelling ambiguity is not resolved by this comparison.}
