...
\item The montage-convention rasterizer carries the boundary seam (10.7--12.8\% shell deficit) on all grids; the $N=1000$ windows contain modes with shell enhancement up to $4\times$; only the $N=10^4$ gap window was re-solved seam-free, and that re-solve is incomplete ($+2.0\pm0.4$ missed in its sub-interval; two solves left different states unconverged).
